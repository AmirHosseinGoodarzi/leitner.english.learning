...
export default function Home() {
  return (
    <div className="home_wrapper antialiased text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-900">
      <div className="min-h-screen relative flex items-center justify-center p-8">
        <div className="sm:px-6 md:px-8">
          <div className={`absolute h-full inset-0 bottom-10 bg-bottom bg-no-repeat bg-slate-50 dark:bg-[#0B1120] ${styles.index_beams}`}>
            <div
              className={`absolute inset-0 ${styles.bg_grid} bg-[bottom_1px_center] dark:bg-bottom dark:border-b dark:border-slate-100/5`}
              style={{
          ...
          <div className="relative max-w-5xl mx-auto pt-10">
            ...
            <div className="mt-6 sm:mt-10 flex justify-center space-x-6 text-sm">
              ...
              <div className="w-full md:w-1/2 mx-auto flex flex-col lg:flex-row items-center justify-center gap-10 p-7 pb-0">
                <button onClick={googleSignInHandler} className="bg-slate-900 dark:bg-slate-100 py-3 px-6 rounded-md text-white dark:text-slate-700">
                  <div className="flex item-center justify-center gap-3">
                    <GoogleIcon className="w-5 h-5 mt-0.5" /> Sign in with
                    Google
                  </div>
                </button>
              </div>
